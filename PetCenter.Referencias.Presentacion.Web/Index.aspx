<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="PetCenter.Referencias.Presentacion.Web.Index" %>
...
<head>
    ...
    <link rel="stylesheet" href="<%= ResolveClientUrl("https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css") %>">
    <link href="<%= ResolveClientUrl("https://fonts.googleapis.com/css?family=Montserrat") %>" rel="stylesheet" type="text/css">
    <link href="<%= ResolveClientUrl("https://fonts.googleapis.com/css?family=Lato") %>" rel="stylesheet" type="text/css">
    <script src="<%= ResolveClientUrl("https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js") %>"></script>
    <script src="<%= ResolveClientUrl("https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js") %>"></script>



    <link href="<%= ResolveClientUrl("~/Resources/Content/css/estilos.css") %>" rel="stylesheet" type="text/css">
    <%--<link href="Resources/Content/css/estilos.css" rel="stylesheet" type="text/css">    --%>    
    <script type="text/javascript">
        $(document).ready(function () {
            $("#solicitud").on("click", function () {
                location.href = 'Solicitud/Nuevo';
            });
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#myPage">
                    <img src="Resources/Content/img/logo.png" /></a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li id="solicitud"><a href="#">SOLICITUD</a></li>
                   <%--  <li id="solicitud">SOLICITUD</li>--%>
