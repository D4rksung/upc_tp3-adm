...
namespace PetCenter.Referencias.Presentacion.Web.Helpers.Html
{
    public static class WebGridExtension
    {
            ...
            bool explicitlyCalled)
        {
            ...
            ul.MergeAttribute("class", "pagination pagination-sm asistencia-max-height");
            ...
            if (ModeEnabled(mode, WebGridPagerModes.Numeric) && (totalPages > 1))
            {
                ...
                for (int i = first; i <= last; i++)
                {
                    ...
                    if (i == currentPage)
                    {
                        part.MergeAttribute("class", "asistencia-active");
                    }
            ...
            var contenido = string.Concat(
                "<div class='asistencia-foot-page'>Registros : ",
